		...
		<table border="0" bgcolor="black" align="center" width="100%" style="height:100px">
         ...
         <div class="bg">
          <div class="container">
         	...
         	<p>${phoneStatus.reason }</p>
         				<a class="btn btn-primary" href="${pageContext.request.contextPath}/finalStatus${phoneStatus.voucherId}/Submitted">Submitted</a>
						<a class="btn btn-warning" href="${pageContext.request.contextPath}/finalStatus${phoneStatus.voucherId}/Approved (by FSO)">Approve</a>
						<a class="btn btn-success" href="${pageContext.request.contextPath}/finalStatus${phoneStatus.voucherId}/Paid">Paid</a>
						
						<form action="${pageContext.request.contextPath}/finalStatus${phoneStatus.voucherId}/Rejected (by FSO)">
							<div>
