          ...
          <div class="container">
         	...
         	<table class="table table-striped">
         		<tr>
         			...
         			<tr>
         				<td>${travelStatus.place }</td>
         				<td>${travelStatus.mode }</td>
         				<td>${travelStatus.date}</td>

         			</tr>

         	</table>
         	<h5 style="font-weight: bold">Reason for voucher enrollment:</h5>
         	<p>${travelStatus.reason }</p>
         	
         				<a class="btn btn-primary" href="${pageContext.request.contextPath}/finalStatus${travelStatus.voucherId}/Submitted">Submitted</a>
						<a class="btn btn-warning" href="${pageContext.request.contextPath}/finalStatus${travelStatus.voucherId}/Approved (by FSO)">Approve</a>
						<a class="btn btn-success" href="${pageContext.request.contextPath}/finalStatus${travelStatus.voucherId}/Paid">Paid</a>
						
						<form action="${pageContext.request.contextPath}/finalStatus${travelStatus.voucherId}/Rejected (by FSO)">
							<div>
