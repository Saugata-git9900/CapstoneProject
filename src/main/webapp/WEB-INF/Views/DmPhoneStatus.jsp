          ...
          <div class="container">
         	...
         	<table class="table table-striped">
         		<tr>
         			...
         			<tr>
         				<td>${phoneSetStatus.number }</td>
         				<td>${phoneSetStatus.fromPeriod }</td>
         				<td>${phoneSetStatus.toPeriod }</td>
         				<td>${phoneSetStatus.carrier }</td>

         			</tr>

         	</table>
         	<h5 style="font-weight: bold">Reason for submitting voucher:</h5>
         	<p>${phoneSetStatus.reason}</p>
         	
         				<a class="btn btn-success" href="${pageContext.request.contextPath}/statusupdate${phoneSetStatus.voucherId}/Approved (by DM)">Approve</a>
						<a class="btn btn-warning" href="${pageContext.request.contextPath}/statusupdate${phoneSetStatus.voucherId}/Rejected (by DM)">Reject</a>
