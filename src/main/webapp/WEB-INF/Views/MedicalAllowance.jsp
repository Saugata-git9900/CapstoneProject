...
<body>
	<table border="0" bgcolor="black" align="center" width="100%" style="height:100px">
         ...
         <div class="bg">
		  <div class="container">
		  <h2 style="font-family: bold;text-align: center"><u>Medical Allowance Submission Form</u></h2><br/>
		  	<hr>
		  	<form action="addMed" method="post" class="form-inline" align="center">
		  	
		  		<label for="nature"><b>Nature of illness:</b></label>
		  		<input type="text" id="nature" name="nature" placeholder="Enter nature of ilness" required> <br/><br/>
		  		<label for="date"><b>Date of illness:</b></label>
				<input type="date" id="date" name="date" placeholder="Enter illness date" required> <br/><br/>
