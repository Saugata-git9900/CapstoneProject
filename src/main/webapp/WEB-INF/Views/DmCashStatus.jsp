          ...
          <div class="container">
         	...
         	<table class="table table-striped">
         		<tr>
         			...
         			<tr>
         				<td>${cashSetStatus.recipent }</td>
         				<td>${cashSetStatus.date }</td>

         			</tr>

         	</table>
         	<h5 style="font-weight: bold">Reason for submitting voucher:</h5>
         	<p>${cashSetStatus.reason }</p>
         	
         				<a class="btn btn-success" href="${pageContext.request.contextPath}/statusupdate${cashSetStatus.voucherId}/Approved (by DM)">Approve</a>
						<a class="btn btn-warning" href="${pageContext.request.contextPath}/statusupdate${cashSetStatus.voucherId}/Rejected (by DM)">Reject</a>
