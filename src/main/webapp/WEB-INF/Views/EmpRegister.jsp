...
<body>
	<table border="0" bgcolor="black" align="center" width="100%" style="height:100px">
		...
		<div class="container">
		  <h2 style="font-family: bold;text-align: center"><u>Employee Registration Form</u></h2><br/>
		  	<hr>
		  	<form action="${pageContext.request.contextPath}/EmpRegister" method="post" class="form-inline" align="center">
				...
				<input type="tel"  name="contact" placeholder="Enter Contact No." required> <br/><br/>
