...
<html>
	...
	<body>
		...
		<div class="container" align="center">
			<h3><span class="label label-default"><u><b>Employee Login</b></u></span></h3><br/>
			<form action="employeeLogin" method="post" class="form-inline" align="center">
				...
				<a href="${pageContext.request.contextPath}/empRgstr" class="btn btn-info">SignUp</a>
			</form>
