...
<html>
	...
	<body>
		...
		<div class="container" align="center">
			<h3><span class="label label-default"><u><b>Department Manager Login</b></u></span></h3><br/>
			<form action="dmLogin" method="post" class="form-inline" align="center">
				...
				<a href="${pageContext.request.contextPath}/dmRgstr" class="btn btn-info">SignUp</a>
			</form>
