		...
		<table border="0" bgcolor="black" align="center" width="100%" style="height:100px">
         ...
         <div class="bg">
          <div class="container">
         	...
         	<p>${cashStatus.reason }</p>
         	
         	
         				<a class="btn btn-primary" href="${pageContext.request.contextPath}/finalStatus${cashStatus.voucherId}/Submitted">Submitted</a>
						<a class="btn btn-warning" href="${pageContext.request.contextPath}/finalStatus${cashStatus.voucherId}/Approved (by FSO)">Approve</a>
						<a class="btn btn-success" href="${pageContext.request.contextPath}/finalStatus${cashStatus.voucherId}/Paid">Paid</a>
						
						<form action="${pageContext.request.contextPath}/finalStatus${cashStatus.voucherId}/Rejected (by FSO)">
							<div>
						...
						<%--<a class="btn btn-danger" href="${pageContext.request.contextPath}/finalStatus${cashStatus.voucherId}/Rejected (by FSO)">Reject</a>--%>
						</br>
