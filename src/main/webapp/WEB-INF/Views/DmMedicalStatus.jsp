          ...
          <div class="container">
         	...
         	<table class="table table-striped">
         		<tr>
         			...
         			<tr>
         				<td>${medicalSetStatus.nature }</td>
         				<td>${medicalSetStatus.date }</td>

         			</tr>

         	</table>
         	<h5 style="font-weight: bold">Reason for submitting voucher:</h5>
         	<p>${medicalSetStatus.reason }</p>
         	
         				<a class="btn btn-success" href="${pageContext.request.contextPath}/statusupdate${medicalSetStatus.voucherId}/Approved (by DM)">Approve</a>
						<a class="btn btn-warning" href="${pageContext.request.contextPath}/statusupdate${medicalSetStatus.voucherId}/Rejected (by DM)">Reject</a>
